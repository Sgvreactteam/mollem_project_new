      ...
      <div className="w-full bg-white table mt-8 rounded-2xl">
        <div className="w-[100%] flex flex-row borderColor headings">
          <div className="w-[10%] items-center flex justify-center px-2 py-2">
            <th className="text-xs font-semibold text-[#6B7280]">{language==='english'? 'Notes':'ملحوظة'}</th>
          </div>
          ...
          <div className="w-[10%] items-center flex justify-end px-2 py-2">
            <th className="text-xs font-semibold text-[#6B7280]">{language==='english'? 'Contract':'عقد'}</th>
          </div>
          <div className="w-[10%] items-center flex justify-end px-2 py-2">
            <th className="text-xs font-semibold text-[#6B7280]">{language==='english'? 'Complexity':'تعقيد'}</th>
            <span
              className="info-icon"
          ...
          <div className="w-[10%] items-center flex justify-end px-2 py-2">
            <th className="text-xs font-semibold text-[#6B7280]">{language==='english'? 'Location':'موقع'}</th>
          </div>
          <div className="w-[10%] items-center flex justify-end px-2 py-2">
            <th className="text-xs font-semibold text-[#6B7280]">{language==='english'? 'Duration':'مدة'}</th>
          </div>
          <div className="w-[10%] items-center flex justify-end px-2 py-2">
            <th className="text-xs font-semibold text-[#6B7280]">{language==='english' ?'Cost':'يكلف'}</th>
          </div>
          <div className="w-[10%] items-center flex justify-end px-2 py-2">
            <th className="text-xs font-semibold text-[#6B7280]">{language==='english'? 'Date':'تاريخ'}</th>
          </div>
          <div className="w-[10%] items-center flex justify-end px-2 py-2">
            <th className="text-xs font-semibold text-[#6B7280]">{language==='english'? 'Category':'فئة'}</th>
          </div>
          <div className="w-[10%] items-center flex justify-end px-2 py-2">
            <th className="text-xs font-semibold text-[#6B7280]">{language==='english'? "Project":"مشروع"}</th>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center my-4 px-10">
          ...
          <p className=" text-xs font-normal">
            {language==='english'? 'Showing':'عرض'} {firstPostIndex + 1} -{" "}
            {lastPostIndex > totalData ? totalData : lastPostIndex} of{" "}
            {totalData}{" "}
          </p>

          <button className="font-semibold bg-primary  text-white rounded-full px-4 py-2 ">
            {" "}
            {language==='english'? 'Print a report':'طباعة تقرير'}
          </button>
        </div>
      </div>
    </div>
